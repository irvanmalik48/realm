...
export default function WaterDrop() {
  ...
  return (
    <a href="https://fresh.deno.dev">
      ...
      >
        <circle cx="18" cy={dropy} r="4" fill={colorScheme.dark.text}></circle>
        <path
