...
export default function WaterDrop() {
  ...
  return (
    <a href="https://fresh.deno.dev">
      ...
      <div className={tw`bg-dark-accent-solid w-full h-[fit-content] pt-5 pb-36 md:pb-8`}>
        <p className={tw`mb-2 w-full text-center`}>
          <span className={tw`bg-dark-bg rounded-3xl font-bold text-dark-accent-solid text-sm m-0 px-8 py-2`}>
