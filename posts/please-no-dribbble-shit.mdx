...
- [A bit of an introduction, I guess](#a-bit-of-an-introduction-i-guess)
- [Okay, so, question](#okay-so-question)
- [Usability and practicality issues](#usability-and-practicality-issues)
- [Oh, the avarice of the human ego](#oh-the-avarice-of-the-human-ego)
...
<div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-3 my-0 items-center justify-center">
  <img
    className="w-full h-auto"
    alt="dribbble-1"
    src="/others/dribbble-1.webp"
  />
  <img
    className="w-full h-auto"
    alt="dribbble-2"
    src="/others/dribbble-2.webp"
  />
</div>
