    ...
    >
      <div>
        <div>
          ...
          <p className={tw`text-dark-text text-sm`}>You can donate through Trakteer or Saweria with the buttons below:</p>
        </div>
        <div className={tw`flex flex-row gap-5`}>
          <a href="https://saweria.co/irvanmalik48" className={tw`bg-transparent px-4 py-2 inline-block text-sm text-uppercase text-dark-text rounded-3xl transition-all duration-200 ease-linear hover:bg-dark-accent-semitrans hover:text-dark-accent-solid ring ring-dark-accent-quartertrans hover:ring-dark-accent-solid font-bold w-[fit-content] mt-5`}>Saweria</a>
          <a href="https://trakteer.id/lapprealm/tip" className={tw`bg-transparent px-4 py-2 inline-block text-sm text-uppercase text-dark-text rounded-3xl transition-all duration-200 ease-linear hover:bg-dark-accent-semitrans hover:text-dark-accent-solid ring ring-dark-accent-quartertrans hover:ring-dark-accent-solid font-bold w-[fit-content] mt-5`}>Trakteer</a>
        </div>
      </div>
      <div className={tw`flex justify-center items-center w-[fit-content] h-full p-3 rounded-xl bg-dark-accent-semitrans text-dark-accent-solid`}>
        <CoffeeIcon />
      </div>
    </div>
  );
