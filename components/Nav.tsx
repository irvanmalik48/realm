...
import FABNav from "@islands/FABNav.tsx";

export default function Nav(props: { active: string }) {
  return (
    <nav
      className={tw`bg-dark-nav h-auto md:h-screen w-full text-dark-text fixed md:sticky md:top-0 bottom-0 shadow z-50 m-0 overflow-y-clip flex flex-row md:flex-col justify-between md:w-[fit-content] p-4`}
    >
      <div
        className={tw`grid grid-cols-4 md:flex md:flex-col w-auto justify-center items-center gap-3 md:gap-5`}
      >
        <NavItem
          active="home"
