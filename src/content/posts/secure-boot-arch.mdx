...
tags:
  - "arch"
  - "linux"
keywords: "arch, linux, secure boot, uefi, tutorial, arch linux, archlinux, archlinux secure boot, arch linux secure boot, archlinux secure boot, efitools, sbsigntools, openssl"
---
