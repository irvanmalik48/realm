...
date: "2021-09-25"
description: "Setup Apache, MySQL, and phpMyAdmin manually on Arch."
tags:
  - "arch"
  - "linux"
  - "mysql"
  - "php"
keywords: "arch, linux, mysql, php, apache, phpmyadmin, lamp, mariadb, sql, database, server, web server, installation, setup, manual, archlinux"
---
