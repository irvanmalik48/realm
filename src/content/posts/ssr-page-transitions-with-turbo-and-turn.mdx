...
tags:
  - "javascript"
  - "astro"
keywords: "astro, javascript, page transitions, turbo, turn, domchristie, hotwired, html, css, animation, webdev, web development, web development blog, blog, blog post, blog post series, series, tutorial, tutorials"
---
...
```astro
<!-- some code -->
<main class="some-class" data-turn-enter data-turn-exit>
  <slot />
</main>
<!-- some more code -->
```
