...
date: "2023-04-02"
description: "JavaScript functional programming is good."
tags:
  - "javascript"
  - "web"
...
This code is functional because it describes what to do. It tells the computer to take an array of numbers, and return a new array of numbers that are each doubled.
...
This is fine, but it's not very flexible. What if you want to apply the same functions to a different value? You'd have to rewrite the code:

```js
const result = triple(double(addOne(2)));
```
