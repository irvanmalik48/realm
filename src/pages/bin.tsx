            ...
            <AccordionItem value="tou">
              ...
              <AccordionContent className="text-foreground/70">
                <p>
                  ...
                  That&apos;s it really. Due to the free nature of Vercel
                  KV&apos;s Hobby plan (which I am using to store the pastes),
                  each paste has a maximum size of 1MB. In order to save space,
                  pastes will be expired and deleted after 14 days.
                </p>
                <p className="mt-3">
