...
const HIGHLIGHT_FEATURES = [
  {
    ...
    tooltip:
      "Next.js 16 feature rendering static parts ahead of time and streaming dynamic islands on demand.",
  },
  {
    icon: Workflow,
    ...
    tooltip:
      "Native View Transition API integration creating cinematic, hardware-accelerated route navigation.",
  },
  {
    icon: Activity,
    ...
    tooltip:
      "Threaded conversations with in-place editing, Markdown support, and optimistic emoji reaction physics.",
  },
  {
    icon: ShieldCheck,
    ...
    tooltip:
      "Zero-trust session cookies with cross-origin proxy endpoints, CSRF protection, and Argon2id hashing.",
  },
];
  ...
  return (
    <TooltipProvider delayDuration={150}>
      <div className="flex flex-col">
        ...
        {/* Architectural Highlights - Uses Tooltips */}
              ...
              return (
                <Tooltip key={feat.title}>
                  <TooltipTrigger asChild>
                    <div className="rounded-lg border border-border/70 bg-card/40 p-3.5 flex flex-col gap-1.5 shadow-2xs hover:border-border transition-colors cursor-help group">
