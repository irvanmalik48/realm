...
import { LuBriefcase, LuHome, LuInfo, LuNewspaper, LuPlus } from "@qwikest/icons/lucide";
import { SiMastodon, SiTelegram, SiLinkedin, SiGithub } from "@qwikest/icons/simpleicons";
...
export default component$(() => {
  ...
  return (
    <>
      <button id="controller" class={
        `transition z-[21] rounded-full fixed right-5 bottom-5 md:right-10 md:bottom-10 p-5 ${isOpen.value ? "bg-cyan-500 text-neutral-950" : "bg-neutral-800 text-neutral-100 bg-opacity-50 backdrop-blur-lg"
        }`
      }
        onClick$={() => {
      ...
      <nav class="w-full fixed bottom-0 h-[30vh] md:h-[75vh] lg:h-[50vh] bg-neutral-950 rounded-t-2xl z-20 p-5 pt-7 md:p-10"
        style={{
      ...
      >
        <div class="absolute w-fit left-5 bottom-5 md:left-10 md:bottom-10">
          <p class="text-neutral-100 font-heading font-medium uppercase">Social Links</p>
