...
export class BackgroundContext {
  ...
  >
    <rect
      ...
      fill="${
      colorScheme[this.themeSelection as keyof typeof colorScheme].light
        .superdark
    }"
    />
    <circle
      ...
      fill="${
      colorScheme[this.themeSelection as keyof typeof colorScheme].light.bg
    }"
    />
    <rect
      x="518.291"
      ...
      fill="${
      colorScheme[this.themeSelection as keyof typeof colorScheme].light.nav
    }"
    />
    <path
    ...
    <circle cx="1400" cy="1400" r="50" fill="${
      colorScheme[this.themeSelection as keyof typeof colorScheme].light.accent
        .solid
    }" fill-opacity="0.3" />
