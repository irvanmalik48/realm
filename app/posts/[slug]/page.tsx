...
export default async function Page({ params }: { params: { slug: string } }) {
  ...
  return (
    <>
      ...
      />
      <main className="relative prose prose-invert prose-code:font-mono prose-pre:rounded-xl prose-headings:font-heading prose-headings:border-b-2 prose-headings:border-neutral-800 prose-h2:py-3 prose-h3:py-3 prose-h4:py-3 prose-h5:py-3 prose-img:rounded-xl prose-img:border-2 prose-img:border-neutral-800 prose-h1:text-center py-48 mx-auto max-w-4xl px-5">
