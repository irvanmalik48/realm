...
Speaking of enums, you can also create an enum type in Typescript. Let's take a look at an example.
...
const color: Color = Color.Red; // ✅ Correct typings
const color2: Color = Color.Yellow; // ❌ Yellow does not exist in the enum

// You can also assign a value to each enum
enum Color {
  Red = "#ff0000",
  Green = "#00ff00",
  Blue = "#0000ff",
...
const color: Color = Color.Red; // This will return "#ff0000"
```
